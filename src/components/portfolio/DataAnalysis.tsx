  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        <div>
          <h3 className="mb-3 text-lg font-semibold text-accent">SQL 쿼리 작성 능력</h3>
          <p className="mb-4 text-stone-400">작업 빈도: 주 수십 건</p>
          <ul className="mb-4 space-y-1 text-sm text-stone-500">
          ...
          <pre className="overflow-x-auto rounded-xl bg-stone-950 p-4 text-sm text-stone-300">
...
ORDER BY date DESC;`}</code>
        ...
        <div>
          <h3 className="mb-3 text-lg font-semibold text-accent">Tableau 활용</h3>
        ...
        <div>
          <h3 className="mb-3 text-lg font-semibold text-accent">Python 활용</h3>
